...
public class PCM8Signed : IAudioEncoding
{
    ...
    {
        foreach (var s in Data) w.Write(s);
    }
    ...
    public List<IAudioEncoding> ChangeBlockSize(List<IAudioEncoding> blocks, int newBlockSize)
    {
        ...
        foreach (var b in blocks) samples.AddRange((sbyte[])b.RawData());
        ...
        {
            var samplesPerBlock = newBlockSize;
            var currSample = 0;
    ...
    {
        var ret = new PCM8Signed { Data = new sbyte[Data.Length] };
